...
![Task 3a](<screenshots/Screenshot (314).png>)

---

#### Screenshot 7 — Terminal showing a successful SSH login

![Task 3b](<screenshots/Screenshot (315).png>)
...
![Task 4a](<screenshots/Screenshot (316).png>)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![Task 4b](<screenshots/Screenshot (317).png>)

---

#### Screenshot 10 — Output of `mysql --version`

![Task 4c](<screenshots/Screenshot (318).png>)
...
![alt text](<screenshots/Screenshot (322).png>)
...
![Task 7](<screenshots/Screenshot (323).png>)

---

#### Screenshot 16 — `curl` output proving the backend responds

![Task 7b](<screenshots/Screenshot (324).png>)
...
![Task 8](<screenshots/Screenshot (325).png>)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![Task 8b](<screenshots/Screenshot (326).png>)
