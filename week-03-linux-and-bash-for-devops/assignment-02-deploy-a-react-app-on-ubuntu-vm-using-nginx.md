...
![alt text](<screenshots/wk 3 Screenshot (4).png>)
---
...
![alt text](<screenshots/wk 3 Screenshot (5).png>)
...
![alt text](<screenshots/wk 3 Screenshot (6).png>)
...
![alt text](<screenshots/wk 3 Screenshot (7).png>)
...
![alt text](<screenshots/wk 3 Screenshot (3).png>)
...
![alt text](<screenshots/wk 3 Screenshot (8).png>)
...
![alt text](<screenshots/wk 3 Screenshot (9).png>)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![alt text](<screenshots/wk 3 Screenshot (10).png>)
...
![alt text](<screenshots/wk 3 Screenshot (11).png>)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![alt text](<screenshots/wk 3 Screenshot (2).png>)
