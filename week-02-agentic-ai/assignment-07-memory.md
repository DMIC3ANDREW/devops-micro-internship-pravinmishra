...
![Task 1](<screenshots/Screenshot (262).png>)
...
![Task 2](<screenshots/Screenshot (261).png>)

---

#### Screenshot 3 — The `MEMORY.md` file open in VS Code showing the saved content

![Task 3](<screenshots/Screenshot (263).png>)
...
![Task 4](<screenshots/Screenshot (264).png>)
...
![Task 5](<screenshots/Screenshot (265).png>)

---

#### Screenshot 6 — Claude refusing JavaScript request based on memory rule

![Task 6](<screenshots/Screenshot (267).png>)
...
https://www.linkedin.com/posts/andrew-ogunlana-70654ba7_devops-agenticai-claudecode-share-7488804017779785728-4cpL/?utm_source=share&utm_medium=member_desktop&rcm=ACoAABau_jYBg6kU-k2bFgLhNF2byWrnftwaanA
