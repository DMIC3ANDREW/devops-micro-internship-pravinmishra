...
![Task 1](<screenshots/2 Screenshot (1).png>)
...
![Task 2](<screenshots/2 Screenshot (2).png>)
...
![Task 3](<screenshots/2 Screenshot (4).png>)
...
![Task 4](<screenshots/2 Screenshot (7).png>)

---

#### Screenshot 5 — Claude refusing or warning against adding React because of the "No JavaScript" convention defined in CLAUDE.md

![Task 4](<screenshots/2 Screenshot (2).png>)
...
![Task 5](<screenshots/2 Screenshot (6).png>)
