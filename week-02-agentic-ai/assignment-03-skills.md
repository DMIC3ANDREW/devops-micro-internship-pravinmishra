...
![Task 1](<screenshots/3 Screenshot (1).png>)
...
![Task 2](<screenshots/3 Screenshot (2).png>)

---

#### Screenshot 3 — Screenshot 3 — `tf-plan/SKILL.md` frontmatter showing `allowed-tools: Bash, Read, Grep` (no Write) and `disable-model-invocation: true`

![Task 2](<screenshots/3 Screenshot (3).png>)
...
![Task 3](<screenshots/3 Screenshot (4).png>)
...
![Task 4](<screenshots/3 Screenshot (5).png>)
---
